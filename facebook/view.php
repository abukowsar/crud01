...
*/
	...
	echo "<tr> <th>ID</th><th>firstName</th><th>lastName</th> <th>email</th> <th>password</th> <th>birthDate</th> <th>hobby</th><th>favFood</th> <th>comment</th> <th>created</th><th>Modified</th><th>Image</th><th>Edit</th><th>Delete</th></tr>";
	...
	for ($i = $start; $i < $end; $i++)
	{
		...
		echo '<td><a href="showfile.php?id=' . mysql_result($result, $i, 'id') . '">Image</a></td>';
