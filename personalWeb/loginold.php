...
<body>
 ...
 <section id="menu-section" class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="section-title text-center">
                            <h3>Member Login</h3>
                            <p>[Only for Registered member]</p>
                        </div>
                    </div>
                    <div class="row">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-offset-2 col-sm-10">
    <br/><br/><br/>
    <div class="list-group">  <a href="registration.php" class="list-group-item active">Sign Up </a>
                        ...
                        <div class="col-md-4">
                            <div class="footer-contact-info">
                                <h4>instructions</h4>
                                <ul>
                                    <li><strong>User Name :</strong> Email id</li>
                                    <li><strong>Password :</strong> 6-8 character</li>
                                    <li><strong>Forget Password :</strong> Reset your password</li>
